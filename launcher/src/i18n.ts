...
const en = {
  ...
  supportBody: "Star the repository and open my X profile to help more developers find Codex Route Hub.",
  star: "Star on GitHub",
...
const zh: Record<keyof typeof en, string> = {
  ...
  continue: "继续",
  supportTitle: "开始之前",
  supportBody: "请为仓库 Star，并打开我的 X 主页，帮助更多开发者发现 Codex Route Hub。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  continue: "続ける",
  supportTitle: "開始する前に",
  supportBody: "より多くの開発者に Codex Route Hub を知ってもらうため、リポジトリに Star を付け、私の X プロフィールを開いてください。",
  star: "GitHub で Star",
